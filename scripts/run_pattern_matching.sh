make -j && srun -p V100 --gres=gpu:1 ncu --call-stack --nvtx --section SourceCounters --import-source 1 -o report%i ./bin/pm data/data_graph_500.bin 0100110110010110110010100
